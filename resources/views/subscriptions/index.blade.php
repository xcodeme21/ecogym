...
@section('content')
    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            @permission(['manage-ecogym','pagehead-stats'])
                                    ...
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div id="subscription-daterangepicker"
                                                 class="ecogym-daterangepicker btn bg-grey-50 daterange-padding no-border color-grey-600 hidden-xs no-shadow">
                        ...
                        <div class="panel-body bg-white">
                            ...
                            @else
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            @permission(['manage-ecogym','manage-subscriptions','edit-subscription'])
                                                            <a href="{{ action('SubscriptionsController@edit',['id' => $subscription->id]) }}">
                                                                Edit details
                                                            </a>
                                                            @endpermission
                                                        </li>
                                                        @permission(['manage-ecogym','manage-subscriptions','change-subscription'])
                                                        <li>
                                                        ...
                                                        <li>
                                                            @endpermission
                                                            @permission(['manage-ecogym','manage-subscriptions','delete-subscription'])
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="ecogym_paging pull-right">
